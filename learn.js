//learn.js displays the learning guide.
...
function learn_scrollEvent(e){
    ...
    else if(view_displacement.y<-(learn_1.height+learn_2.height+30+100+10)) view_displacement.y = -(learn_1.height+learn_2.height+30+100+10);
}